      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                <div class="x_panel">
                        <div class="x_title">
                          <h2>Multiple Choices<small>Questionnaire</small></h2>
                          <!-- <ul class="nav navbar-right panel_toolbox">
                            <li><a href="<?php //echo base_url('questionnaires/addMultipleChoice'); ?>"><i class="fa fa-user-plus"></i> Add Multiple Question</a>
                          </ul> -->
                          <div class="clearfix"></div>
                </div>
