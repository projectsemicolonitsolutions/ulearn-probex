      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                <div class="x_panel">
                        <div class="x_title">
                          <h2>Course <small>Path</small></h2>
                          <!-- <ul class="nav navbar-right panel_toolbox">
                            <li><a href="add_department.html"><i class="fa fa-user-plus"></i> Add Course Path</a>
                          </ul> -->
                          <div class="clearfix"></div>
                </div>
                  ...
                  <tbody>
                    <?php foreach ($result->result() as $row): ?>
                      <tr>
                        ...
                        <td><?php echo $row->department_tinker; ?></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
