      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                <div class="x_panel">
                        <div class="x_title">
                          <h2>Teacher<small>Accounts</small></h2>
                          <ul class="nav navbar-right panel_toolbox">
                            <li><a href="<?php echo base_url('users/addTeacherAccount'); ?>"><i class="fa fa-user-plus"></i> Add Teacher</a>
                          </ul>
                          <ul class="nav navbar-right panel_toolbox">
                            <li><a href="<?php echo base_url('users/downloadForm'); ?>"><i class="fa fa-user-plus"></i> Download Form</a>
                          </ul>
                          <ul class="nav navbar-right panel_toolbox">
                            <li>
                              <form method="post" enctype="multipart/form-data" action="<?php echo base_url('users/importTeacher'); ?>">
                  ...
                  <tbody><?php
                    foreach ($result->result() as $row) { ?>
                      <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('users/updateTeacher/'.$row->teacher_no); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                            <!-- <a href="<?php //echo base_url('users/archiveAdmin/'.$row->teacher_no); ?>" class="btn btn-danger"><i class="fa fa-database"></i></a> -->
                        </td>
                      </tr><?php
                    } ?>
                  </tbody>
