                ...
                <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="x_panel">
                            ...
                            <div class="x_content">
                              <br />
                              <form id="demo-form2" data-parsley-validate method="post" action="<?php echo base_url('users/updateDataStudent'); ?>" class="form-horizontal form-label-left">
                                <?php
                                $user_id = "";
                                $student_no = "";
                                $first_name = "";
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" id="admin_no"  name="student_no" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $student_no; ?>" readonly>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label for="email-address" class="control-label">Section</label>
                                      <select id="heard" name="section_id" class="form-control" required>
                                          <?php foreach ($r->result() as $row): ?>
                                            <option value="<?php echo $row->section_desc; ?>"><?php echo $row->section_desc; ?></option>
                                          <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
