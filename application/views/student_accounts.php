                ...
                <div class="x_panel">
                        <div class="x_title">
                          ...
                          <ul class="nav navbar-right panel_toolbox">
                            <li><a href="<?php echo base_url('users/addStudent'); ?>"><i class="fa fa-user-plus"></i> Add Student</a>
                          </ul>
                          <ul class="nav navbar-right panel_toolbox">
                            <li><a href="<?php echo base_url('users/downloadFormStudent'); ?>"><i class="fa fa-user-plus"></i> Download Form</a>
                          </ul>
                          <ul class="nav navbar-right panel_toolbox">
                            <li>
                              <form method="post" enctype="multipart/form-data" action="<?php echo base_url('users/importStudent'); ?>">
                  ...
                  <tbody><?php
                    foreach ($result->result() as $row) { ?>
                      <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('users/updateStudent/'.$row->student_no); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                            <!-- <a href="<?php //echo base_url('users/archiveAdmin/'.$row->user_id); ?>" class="btn btn-danger"><i class="fa fa-database"></i></a> -->
                        </td>
                      </tr><?php
                    } ?>
                  </tbody>
