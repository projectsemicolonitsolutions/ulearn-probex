      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                <div class="x_panel">
                        <div class="x_title">
                          <h2>Topic <small> Assignment</small></h2>
                          <!-- <ul class="nav navbar-right panel_toolbox">
                            <li><a href="add_assignment.html"><i class="fa fa-user-plus"></i> Add New Topic Assignment</a>
                          </ul> -->
                          <div class="clearfix"></div>
                </div>
                  ...
                  <tbody>
                    <?php foreach ($result->result() as $row): ?>
                      <tr>
                        ...
                        <td><?php echo $row->assignment_inst; ?></td>
                        <td><?php echo $row->assignment_file; ?></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
