      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                <div class="x_panel">
                        <div class="x_title">
                          <h2>Category <small> Available</small></h2>
                          <!-- <ul class="nav navbar-right panel_toolbox">
                            <li><a href="add_category.html"><i class="fa fa-user-plus"></i> Add New Available Category</a>
                          </ul> -->
                          <div class="clearfix"></div>
                </div>
