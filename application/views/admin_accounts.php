    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <!-- table start -->
          <div class="x_content" ng-controller="content">
                <div class="x_panel">
                        <div class="x_title">
                          <h2>Administrator<small>Accounts</small></h2>
                          <ul class="nav navbar-right panel_toolbox">
                            <li><a href="<?php echo base_url('users/addAdminAccount'); ?>"><i class="fa fa-user-plus"></i> Add Admin</a>
                          </ul>
                          <div class="clearfix"></div>
                </div>
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  foreach ($result->result() as $row) { ?>
                    <tr>
                      <td><b><?php echo $row->admin_no; ?></b></td>
                      ...
                      <td>
                          <a href="<?php echo base_url('users/updateAdmin/'.$row->admin_no); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
