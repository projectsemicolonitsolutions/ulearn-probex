        ...
        <div class="right_col" role="main">
                <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="x_panel">
                            <div class="x_title">
                              <h2>Administrator <small>Add New Account</small></h2>
                              <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                              <br />
                              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url('users/updateData'); ?>">
                                <?php
                                $user_id = "";
                                $admin_no = "";
                                $first_name = "";
                                ...
                                <div class="form-group">
                                  ...
                                  <label class="control-label" for="employee_id">Administrator Number</label>
                                  <input type="text" id="admin_no"  name="admin_no" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $admin_no; ?>" readonly>
                                  </div>
                                </div>
