      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                <div class="x_panel">
                        <div class="x_title">
                          <h2>Category <small> Topics Content</small></h2>
                          <!-- <ul class="nav navbar-right panel_toolbox">
                            <li><a href="add_content.html"><i class="fa fa-user-plus"></i> Add New Topic Content</a>
                          </ul> -->
                          <div class="clearfix"></div>
                </div>
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th>Category ID</th>
                      <th>Topic ID</th>
                      <th>Topic Content/ Try it yourself codes</th>
                      <th>Topic Handouts</th>
                      <th>Topic Video</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($result->result() as $row): ?>
                      <tr>
                        ...
                        <td><?php echo $row->topic_content; ?></td>
                        <td><?php echo $row->topic_handouts; ?></td>
                        <td><?php echo $row->topic_video; ?></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
